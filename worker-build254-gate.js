// ACC OS X — BUILD 257.4 PRODUCTION GATE + BUILD 256 SYSTEM ORCHESTRATOR ROUTE
// Budgeted KAI Research Intelligence feeds a resilient GPT-OSS 120B MATERIAL director.
// BUILD 257.4 keeps the strict 8.5 threshold while normalizing Workers AI response formats and bounded fallbacks.
...
import materialWorker from "./worker-material-director-v2574.js";
...
const PACKAGE_REVISION="BUILD257_4_RESILIENT_MODEL_IO";
const GATE_REVISION="BUILD257_4_PRODUCTION_GATE";
