// ACC OS X — BUILD 257.1 PRODUCTION GATE + BUILD 256 SYSTEM ORCHESTRATOR ROUTE
// Budgeted KAI Research Intelligence feeds a strict latency-budgeted Studio quality board.
// BUILD 257.1 keeps the 8.5 threshold while preventing long serial AI chains from overrunning the PWA mission wait.
// Caption, publishing, Meta routing and stored channel data remain unchanged.
import coreWorker from "./worker-stage-normalizer.js";
import researchWorker from "./worker-research-intelligence-v2552.js";
import brainWorker from "./worker-kai-brain-v257.js";
...
const PACKAGE_REVISION="BUILD257_1_LATENCY_BUDGETED_RECOVERY";
const GATE_REVISION="BUILD257_1_PRODUCTION_GATE";
