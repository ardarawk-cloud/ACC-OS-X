// ACC OS X — BUILD 255.2 PRODUCTION GATE + BUILD 256 SYSTEM ORCHESTRATOR ROUTE
// Budgeted KAI Research Intelligence before Qwen3 iterative Studio Board.
// BUILD 256 adds evidence-grounded SYSTEM/CTO routing without changing production stages.
// Caption and publishing path remain unchanged.
import coreWorker from "./worker-stage-normalizer.js";
import researchWorker from "./worker-research-intelligence-v2552.js";
import brainWorker from "./worker-kai-brain-v2542.js";
...
const PACKAGE_REVISION="BUILD255_2_BUDGETED_RESEARCH";
const GATE_REVISION="BUILD255_2_PRODUCTION_GATE";
