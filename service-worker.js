const CACHE='acc-os-x-build-014-premium-nav';
const ASSETS=['./','./index.html?v=014','./manifest.webmanifest','./icon-192.png','./icon-512.png','./maskable-512.png'];
...
if(e.request.mode==='navigate'){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match('./index.html?v=014')));return;}
