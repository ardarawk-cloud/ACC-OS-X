const CACHE="acc-os-x-build-256-release-sync";
const CORE=["./","./index.html","./app.js","./home-launchpad.js","./release-version-v256.js?rev=BUILD256_RELEASE_SYNC","./poster-studio-v1.js?rev=BUILD253_KAI_CREATIVE","./kai-creative-client.js?rev=BUILD253_KAI_CREATIVE_CLIENT_V1","./pwa-owner-safety-v1.js?rev=PWA_OWNER_SAFETY_V1","./manifest.webmanifest","./acc-os-x-192-build250.png","./acc-os-x-512-build250.png","./acc-os-x-maskable-512-build250.png","./version.json","./build-info.json","./build.json"];
