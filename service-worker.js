...
const CACHE="acc-os-x-build10-page-picker-v19-my-admin";
...
const MAP_CORE=[
  ...
  "./launcher-layout-stability-v1.js?rev=KAI_ONE_LAUNCHER_LAYOUT_STABILITY_V5_ADMIN_ORDER"
];
const CORE=[
  "./",
  "./index.html",
  ...
  "./my-admin-launcher-v1.js?rev=KAI_ONE_MY_ADMIN_V1",
