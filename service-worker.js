const CACHE='acc-os-x-build-019-live-ai-workers';
const ASSETS=['./','./index.html?v=019','./manifest.webmanifest','./icon-192.png','./icon-512.png','./maskable-512.png'];
...
if(e.request.mode==='navigate'){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match('./index.html?v=019')));return;}
