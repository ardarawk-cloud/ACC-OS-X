const CACHE='acc-os-x-build-009-enterprise-database';
const ASSETS=['./','./index.html?v=009','./manifest.webmanifest','./icon-192.png','./icon-512.png','./maskable-512.png'];
...
if(e.request.mode==='navigate'){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match('./index.html?v=009')));return;}
