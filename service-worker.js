...
const CACHE="acc-os-x-build10-page-picker-v16-produce-mobile-history";
...
const CORE=[
  ...
  "./kai-autopilot-folder-fallback-v1.js?rev=KAI_AUTOPILOT_SINGLE_MEDIA_BUTTON_V4_MANUAL_FIRST_MOBILE_HISTORY",
