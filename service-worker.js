const CACHE='acc-os-x-build-012-command-engine';
const ASSETS=['./','./index.html?v=012','./manifest.webmanifest','./icon-192.png','./icon-512.png','./maskable-512.png'];
...
if(e.request.mode==='navigate'){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match('./index.html?v=012')));return;}
