...
const CACHE="acc-os-x-build10-page-picker-v15-produce-mobile-scroll";
...
const CORE=[
  ...
  "./kai-autopilot-folder-fallback-v1.js?rev=KAI_AUTOPILOT_SINGLE_MEDIA_BUTTON_V3_MANUAL_FIRST_MOBILE_SCROLL",
