...
// Semi-auto owner mode: completed K/P/C packages can be shared manually from Android before Meta mapping exists.
(()=>{if(document.querySelector('script[data-acc-semi-auto-publish="v2586"]'))return;const script=document.createElement("script");script.src="./produce-copilot-semi-auto-v2585.js?rev=BUILD258_6_SEMI_AUTO_MANUAL_SHARE";script.dataset.accSemiAutoPublish="v2586";script.async=false;document.head.appendChild(script);})();
