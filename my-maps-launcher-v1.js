...
(() => {
  ...
  function ensureStyle(){
    ...
    style.textContent = `
      ...
      #${ROOT_ID} .acc-map-fallback-v17{position:absolute;inset:0;display:grid;place-items:center;color:var(--map-accent);font-size:.92rem;font-weight:950;letter-spacing:-.04em;z-index:0}
      #${ROOT_ID} .acc-map-logo-v17{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;max-width:none!important;object-fit:cover!important;display:block!important;z-index:2!important;opacity:0!important;pointer-events:none!important}
      #${ROOT_ID} .acc-map-icon[data-image-ready="1"] .acc-map-logo-v17{opacity:1!important}
      #${ROOT_ID} .acc-map-icon[data-image-ready="1"] .acc-map-fallback-v17{opacity:0!important}
  ...
  function tile(map){
    ...
    button.innerHTML = `
      <div class="acc-map-icon" data-image-ready="0">
        <span class="acc-map-fallback-v17">${map.fallback}</span>
        <img class="acc-map-logo-v17" alt="" decoding="async" loading="eager">
      </div>
    ...
    const img = button.querySelector(".acc-map-logo-v17");
    let retries = 0;
